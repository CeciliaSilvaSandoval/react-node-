...
//el skipMissingProperties no funciona con el define , por eso se hizo otro 
...
export class UsersPatchValidator {
    ...
    // No hay problema si no se pone por que la validacion ya se hace arriba
